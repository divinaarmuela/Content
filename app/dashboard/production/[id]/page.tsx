...
import { actionFor, type BoardViewCard, type CardAction } from '../../../lib/board-view-core'
 ...
 * THE CARD PAGE.
 *
 * A card is one deliverable with ONE link and what needs doing. This page
 * shows the same things the board shows — the link (with its label and
...
export default function ItemDetailPage() {
  ...
  // forwards there, keeping old links and notifications working.
  useEffect(() => {
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-4 pb-24 md:pb-0">
      ...
      {isTeam && !isBrief && (hasFiles || folderUrl || canManage) && (
