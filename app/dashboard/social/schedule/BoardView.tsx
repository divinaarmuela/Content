...
/**
 * THE BOARD VIEW: links and what needs doing, on the whole board.
 *
 * The Scheduler page's board, unchanged, now one of the Schedule page's three
 * views — same cards, same five lanes, same side panel, same drag rules. What
 * moved is the address it lives at, not a single rule on it.
 *
 ...
 * takes those and posts on the Calendar view — one pill away in the header
