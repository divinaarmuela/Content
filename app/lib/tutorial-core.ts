  ...
  steps: [
    ...
    },
    {
      ...
      see: [
        ...
        'Go is the one sign-off: it needs the checklist complete, "Aligned with the strategist" and client availability ticked, every acknowledgement in, and — for a plan written or held by anyone but a super admin — the quality checker\u2019s pass. It also books the date.',
      ...
      actions: [
        ...
        'Press "Ask for a review" so the quality checker can pass the plan; tick aligned and confirmed, wait for "2 of 2 acknowledged", press "Confirm — it is go".',
