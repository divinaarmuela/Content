...
const GHOST_TABLES = {
  ...
  //   business on the road from research to handoff; an event is one thing
  //   that happened to it, with the blueprint's points — the score is their
  //   sum. Beside the live `leads` pipeline, touching none of it.
  prospects: [
    ['id', col('string', false)],
    ...
    ['instagram', col('string', true)],
    ['linkedin', col('string', true)],
    ['contact_name', col('string', true)],
    ['contact_role', col('string', true)],
    ['email', col('string', true)],
    ['phone', col('string', true)],
    ['source', col('string', true)],
    ['source_detail', col('string', true)],
    ['stage', col('string', true)],
    ['stage_entered_at', col('string', true)],
    ['owner_id', col('string', true)],
    ['added_by', col('string', true)],
    ['audit_angle', col('string', true)],
    ['loom_url', col('string', true)],
    ['post_url', col('string', true)],
    ['cta_url', col('string', true)],
    ['outreach_at', col('string', true)],
    ['outreach_channel', col('string', true)],
    ['outreach_by', col('string', true)],
    ['replied_at', col('string', true)],
    ['call_at', col('string', true)],
    ['call_notes', col('string', true)],
    ['proposal_url', col('string', true)],
    ['proposal_sent_at', col('string', true)],
    ['deal_value', col('number', true)],
    ['invoice_ref', col('string', true)],
    ['deposit_amount', col('number', true)],
    ['deposit_sent_at', col('string', true)],
    ['deposit_paid_at', col('string', true)],
    ['contract_url', col('string', true)],
    ['signed_at', col('string', true)],
    ['client_id', col('string', true)],
    ['next_action', col('string', true)],
    ['next_action_at', col('string', true)],
    ['not_now_at', col('string', true)],
    ['reopen_at', col('string', true)],
    ['dormant_at', col('string', true)],
  ...
  prospect_events: [
    ['id', col('string', false)],
    ['prospect_id', col('string', false)],
    ['kind', col('string', false)],
    ['at', col('string', false)],
    ['by', col('string', true)],
    ['source', col('string', true)],
  ...
  todos: [
    ['id', col('string', false)],
    //   todos.prospect_id — a reminder the acquisition system made (21 Sep 2026)
    ['prospect_id', col('string', true)],
