...
export const JSON_COLUMNS = {
  ...
  content_applications: [],
  content_assets: [],
  content_items: ['raw_assets', 'scheduler_ids', 'clip_approvals', 'final_files', 'split_out', 'posted_slides', 'asked_ids'],
