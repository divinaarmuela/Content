...
export interface ContentItem {
  ...
  split_out: unknown | null
  split_from: string | null
  asset_captions: unknown | null
  link_saved_at: string | null
  qc_approvals: unknown | null
...
export const JSON_COLUMNS = {
  ...
  content_applications: [],
  content_assets: [],
  content_items: ['raw_assets', 'scheduler_ids', 'clip_approvals', 'final_files', 'split_out', 'asset_captions', 'qc_approvals', 'posted_slides', 'asked_ids'],
